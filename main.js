...
Game.Launch=function()
{
	...
	(true?'<div class="listing">'+loc("Music by %1.",'<a href="https://bsky.app/profile/c418.org" target="_blank">C418</a>')+'</div>':'')+
		...
		var loadLangAndLaunch=function(lang,firstLaunch)
		{
			...
			LoadLang('loc/EN.js?v='+Game.version,function(lang){return function(){
				...
				LoadLang('loc/'+lang+'.js?v='+Game.version,function(){
					var launch=function(){
						Game.Launch();
						if (false) Game.ErrorFrame(); // if (top!=self) Game.ErrorFrame(); // Disable iframe detection
						else
						{
							console.log('[=== '+choose([
								'Oh, hello!',
